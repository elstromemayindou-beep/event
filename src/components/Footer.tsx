import { Mail, Phone, MapPin, Instagram, Facebook, Youtube, Heart, ArrowUp } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8 mb-32">
          ...
          <div className="md:col-span-12 lg:col-span-5 space-y-10">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#D4AF37] hover:border-[#D4AF37] transition-all duration-500 hover:-translate-y-2"><Instagram size={20} /></a>
              <a href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#D4AF37] hover:border-[#D4AF37] transition-all duration-500 hover:-translate-y-2"><Facebook size={20} /></a>
              <a href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#D4AF37] hover:border-[#D4AF37] transition-all duration-500 hover:-translate-y-2"><Youtube size={20} /></a>
            </div>
          </div>
