...
import { ArrowRight, Star, Calendar, Music, Sparkles, MapPin } from 'lucide-react';
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-7xl mx-auto">
          ...
          >
            <div className="flex items-center justify-center space-x-4 mb-4">
              ...
              <span className="text-[#D4AF37] text-sm font-bold tracking-[0.4em] uppercase">Brazzaville • Pointe-Noire</span>
              <div className="h-[1px] w-12 bg-[#D4AF37]" />
            </div>
          ...
          {[
            ...
            >
              <div className="flex justify-center mb-4">
                <stat.icon className="text-[#D4AF37]" size={24} strokeWidth={1} />
              </div>
              <div className="text-4xl font-serif font-bold text-[#1A1A1A]">{stat.value}</div>
              <div className="text-[10px] text-[#999] uppercase tracking-widest font-bold">{stat.label}</div>
            </motion.div>
          ))}
        </div>
      </section>
          ...
          {[
            ...
            >
              ...
              <div className="absolute inset-0 p-12 flex flex-col justify-end text-white space-y-2 pointer-events-none">
                <span className="text-[#D4AF37] text-[10px] font-bold tracking-[0.3em] uppercase">{item.category}</span>
      ...
      <section className="py-40 bg-[#1A1A1A] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
           ...
           <blockquote className="text-4xl md:text-6xl font-serif text-white max-w-5xl mx-auto leading-tight italic">
             "Chez Franck Event’s, nous transformons chaque événement en un moment unique et inoubliable. Spécialisée dans la décoration, l’organisation et la coordination événementielle, notre agence met son savoir-faire, sa créativité et son sens du détail au service de vos plus beaux instants."
           </blockquote>
